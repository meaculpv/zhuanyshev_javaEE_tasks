<%--
    Создайте приложение, в котором мы регистрируем свои данные в базу данных.
    Мы заполняем все поля и выбираем университет. Но если наш университет отсутствует, то мы иеем возможность
    добавить свой вариант, нажав на ссылку "Insert owb".
    После нажатия на ссылку, вы мерейдем на страницу, где вводим свой университет, После добавления,
    мы можем выбирать ее из списка и добавить пользователя.
--%>
